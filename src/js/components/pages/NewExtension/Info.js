...
import {backToCheckProjectUrk, uploadImages} from "../../../actions/newExtension"
...
class Info extends React.Component {
  ...
  prevStep() {
    ...
    this.props.dispatch(backToCheckProjectUrk());
  }
  ...
  render() {
    ...
    return (<form className="form-horizontal" onSubmit={this.handleSubmit}>
        ...
        <div className="form-group">
          <label className="col-lg-2 control-label">Images</label>
