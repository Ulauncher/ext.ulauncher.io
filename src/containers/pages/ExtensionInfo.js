                ...
                <div className="col-md-6">
                  {extensionInfo.images && (
                    <div className="carousel slide" id="carousel1">
                      ...
                      <a data-slide="prev" className="left carousel-control" onClick={this.prevImg}>
                        <span className="icon-prev" />
                      </a>
                      <a data-slide="next" className="right carousel-control" onClick={this.nextImg}>
                  ...
                  <div className="form-horizontal m-t-lg">
                    <div className="form-group">
                      ...
                      <div className="col-lg-8">
                        <a>{extensionInfo.url}</a>
                      </div>
                    </div>
                    <div className="form-group">
                      <label className="col-lg-4">Version</label>
                      <div className="col-lg-8">{extensionInfo.version}</div>
                    </div>
                    <div className="form-group">
                      <label className="col-lg-4">Last updated</label>
                      <div className="col-lg-8">{extensionInfo.last_updated}</div>
                    </div>
                    <div className="form-group">
                      <label className="col-lg-4">Author</label>
                      <div className="col-lg-8">{extensionInfo.author}</div>
                    </div>
                  </div>
                </div>
              </div>
